...
export const environment  = {
    ...
    server:{
      api:'http://xchange.website/api/cointoken', //CHANGE
        // api:'https://webhook.site/d97418f4-59fe-4ccc-923a-f75f7fade76d/api/cointoken'
    },
    blockchain:{
        ETH:{
        ...
        XRP:{
            ...
            // socketURL:'wss://s.altnet.rippletest.net:51233',
            listenerTimer:1*60*1000,
            securePlatformWallet:{
